                    ...
                    {props.loading ? (
                        ...
                        <>
                            <div
                                ...
                                onClick={(event) =>
                                    event.target.classList.contains(
                                        ...
                                        ? null
                                        : changeBrandPopupVisibility(
                                              !brandPopupVisibility
                                          )
                                }
                            >
                            ...
                            <div
                                ...
                                onClick={(event) =>
                                    event.target.classList.contains(
                                        ...
                                        ? null
                                        : changeModelPopupVisibility(
                                              !modelPopupVisibility
                                          )
                                }
                            >
                                <div className="search-body__label">
                                ...
                                >
                                    {props.models[currentBrand] ? (
                                        ...
                                        <div>
                                            No model of this car available
                                        </div>
                                    )}
                                </ul>
                            </div>
                            <button
                                ...
                                disabled={
                                    currentBrand && currentModel ? false : true
                                }
                                onClick={
