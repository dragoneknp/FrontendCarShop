        ...
        <footer className="footer">
            <div className="footer__container container">
                <div className="footer__body footer-body">
                    ...
                    <div className="footer-body__description">
                    ...
                    <nav className="footer__menu footer-menu">
                        <div
                            className={`footer-menu__label ${
                                window.screen.width < 767 ? "arrow" : ""
                            } ${socialPopupOpened ? "_opened" : "_closed"}`}
                            onClick={() =>
                                changeSocialOpened(!socialPopupOpened)
                            }
                        >
                            Company
                        </div>
                        ...
                        >
                            <li className="footer-menu__item">
                                <a href="#home" className="footer-menu__link">
                                    Home
                                </a>
                            </li>
                            <li className="footer-menu__item">
                        ...
                        <nav className="footer__menu footer-menu">
                            <div
                                className={`footer-menu__label ${
                                    ...
                                    companyPopupOpened ? "_opened" : "_closed"
                                }`}
                                onClick={() =>
                                    changeCompanyOpened(!companyPopupOpened)
                                }
                            >
                                Social
                            </div>
                    ...
                    <div className="footer__contactMenu">
                        <nav className="contactMenu">
                            ...
                            <li className="contactMenu__item">
                                <a
                                    id="phoneNumber"
                                    href="tel:(+1) 923 2341 22"
                                    className="contactMenu__link"
                                >
                                    (+1) 923 2341 22
                                </a>
                            </li>
                            <li className="contactMenu__item">
                                <a
                                    id="mail"
                                    href="mailto:contact@tanahairstudio.com"
                                    className="contactMenu__link"
                                >
